...
namespace webrtc
{
    ...
    public:
        ...
        static webrtc::scoped_refptr<PeerConnectionStatsCollectorCallback> Create(PeerConnectionObject* connection);
        void OnStatsDelivered(const webrtc::scoped_refptr<const RTCStatsReport>& report) override;
